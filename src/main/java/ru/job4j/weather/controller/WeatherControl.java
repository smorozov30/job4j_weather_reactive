...
public class WeatherControl {
    ...
    public Mono<Weather> getById(@PathVariable Integer id) {
    ...
    @GetMapping(value = "/hotterThan/{t}")
    public Flux<Weather> getHotterThan(@PathVariable Integer t) {
        return weathers.findAllHotterThan(t);
    }
}
